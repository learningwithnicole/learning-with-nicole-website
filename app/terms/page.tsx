export default function TermsPage() {
  return (
    <main className="min-h-screen container mx-auto px-4 py-16">
      <h1 className="text-3xl font-bold mb-6 text-gray-900">Learner Agreement & Terms</h1>
      <p className="text-gray-700 mb-6">
        These Terms and Conditions form the Learner Agreement between <strong>Learning with Nicole Ltd</strong> (“we”,
        “us”, “our”) and you as the learner or sponsoring organisation (“you”, “your”). By enrolling on a course,
        or accessing our learning platform, you agree to be bound by these terms.
      </p>

      <section className="space-y-4 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">1. Welcome & Enrolment</h2>
        <p className="text-gray-700">
          Your enrolment is complete once you have submitted the course application and, where applicable, made your first
          payment. Your <strong>official course start date</strong> is the date you submit the course application.
        </p>
      </section>

      <section className="space-y-2 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">2. Course Duration</h2>
        <p className="text-gray-700">Standard qualification durations are:</p>
      ...
      <section className="space-y-2 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">3. Contact Details</h2>
        <p className="text-gray-700">
          <strong>Learning with Nicole Ltd (Party A)</strong>
          <br />
          28–30 Enterprise Road
          <br />
          Waterlooville
          <br />
          PO8 0BT
        ...
        <p className="text-gray-700">
          Email:{" "}
          <a
            href="mailto:director@learningwithnicoleltd.co.uk"
          ...
          <br />
          Phone (weekdays only):{" "}
          <a href="tel:+447482122810" className="text-orange-600 hover:text-orange-700 underline">
            07482 122810
          </a>
        </p>
      </section>
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">4. Our Responsibilities (Party A)</h2>
        <p className="text-gray-700">We commit to:</p>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">5. Learner Responsibilities (Party B)</h2>
        <p className="text-gray-700">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          ...
          <li>
            Inform Learning with Nicole Ltd promptly of any absences, workplace changes, or challenges affecting your
            learning.
          </li>
          <li>
            Confirm that <strong>all submitted work is your own</strong>. Plagiarised or AI-generated work may result in
          ...
          <li>Report any safeguarding concerns immediately to your line manager or Learning with Nicole Ltd.</li>
          <li>
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">6. Awarding Body Fees</h2>
        <p className="text-gray-700">
          Awarding body registration fees are <strong>not</strong> included in course package prices. These must be paid
          directly to the awarding body (such as iCQ or NCFE). Costs typically range between{" "}
          <strong>£22 – £160</strong>, depending on the qualification.
        </p>
      </section>

      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">7. Duration, Extensions & Additional Charges</h2>
        <p className="text-gray-700 font-medium">Expected Duration</p>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
        ...
        <p className="text-gray-700 font-medium">Extension Charges</p>
        <p className="text-gray-700">Level 2 / 3 EYP / EYE / BA / CAVA:</p>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          <li>Month 13 – <strong>£60</strong></li>
          <li>Month 14 – <strong>£100</strong></li>
          <li>Month 15 – <strong>£300</strong></li>
        </ul>
        <p className="text-gray-700">Level 3 Residential / Level 5 CYP:</p>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">8. Late Invoice & Payment Policy</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">9. Confidentiality & Data Protection</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          <li>Learners must not share their <strong>Laser Learning</strong> login details with others.</li>
          <li>Learning with Nicole Ltd will not share learner data unnecessarily with third parties.</li>
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">11. Fast Track Option (Transfer Learners)</h2>
        <p className="text-gray-700">
          If you previously completed your qualification with another provider but have not received your certificate,
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          ...
          <li>No full invoice payment is required until Learning with Nicole Ltd is prepared to claim your certificate.</li>
        </ul>
      </section>

      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">12. Certification Process</h2>
        <p className="text-gray-700 font-medium">NCFE Learners</p>
        <p className="text-gray-700">Certificates can only be claimed in <strong>April</strong> or <strong>November</strong>.</p>
        <p className="text-gray-700 font-medium">ICQ Learners</p>
        <p className="text-gray-700">Certificates are normally issued within <strong>one month</strong> after they are claimed.</p>
        <p className="text-gray-700 font-medium">To receive your certificate, you must:</p>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          <li>Complete second IQA sampling, where applicable.</li>
          <li>Complete <strong>all instalment payments</strong> to Learning with Nicole Ltd.</li>
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">13. Starting Your Course</h2>
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          Your Laser Learning login details will be sent to your registered email after payment. You will then be able
          to access your course materials and book one-to-one tutor support.
        </p>
      </section>

      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">14. 14‑Day Refund Policy</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
          <li>
            You have the right to cancel your course within <strong>14 calendar days</strong> from the date you enrolling a
            course.
          </li>
          <li>
            A <strong>full refund</strong> of course fees will be issued if cancellation is requested in writing within
            this 14‑day period.
          </li>
          <li>
            Awarding body registration fees (iCQ / NCFE) are <strong>non‑refundable</strong> once paid to the awarding
            body.
          </li>
          <li>
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">15. Credit Card Payments</h2>
        <p className="text-gray-700">
          Credit card payments are accepted. A small transaction fee may apply. For current details, please contact the
          admin team using the contact information above.
        </p>
      </section>

      <section className="space-y-3 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">16. Governing Law</h2>
        <p className="text-gray-700">
